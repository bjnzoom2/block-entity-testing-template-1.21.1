...
public class CombinerCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE = Identifier.of(BlockEntityTesting.MOD_ID,
            "textures/gui/combiner/combiner_gui.png");
    public static final CategoryIdentifier<CombinerDisplay> COMBINER =
            CategoryIdentifier.of(BlockEntityTesting.MOD_ID, "combiner");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.COMBINER.asItem().getDefaultStack());
    }

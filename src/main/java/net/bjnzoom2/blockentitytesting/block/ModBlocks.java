...
import net.bjnzoom2.blockentitytesting.block.custom.BigCraftingTableBlock;
...
public class ModBlocks {
    ...
    public static final Block BIG_CRAFTING_TABLE = registerBlock("big_crafting_table",
            new BigCraftingTableBlock(AbstractBlock.Settings.create()));
    ...
    public static void registerModBlocks() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(fabricItemGroupEntries -> {
            ...
            fabricItemGroupEntries.add(ModBlocks.BIG_CRAFTING_TABLE);
        });
    }
}
